...
export default function Home() {
  return (
    <div className='w-full h-auto bg-[#0f103c]'>
      ...
      <div className='w-[160px] h-[60px] leading-[60px] text-center rounded-lg border mx-[auto] border-[#666] mb-[150px] bg-[#f4f4f4]'>
        进入
      </div>

      <div className='flex invisible lg:visible justify-between  w-[1080px] mx-[auto]  text-white mb-[140px]'>
      ...
      {/* 视频 */}
      <div className='h-[360px] text-white flex lg:w-[1400px] mx-[auto] items-center mb-[107px]'>
        ...
        ></video> */}
        <div className="h-[360px] w-[640px] object-cover mr-[40px] overflow-hidden">
        ...
        /> */}
        <div>
          <div className='text-[36px] font-[700] leading-[30px] mb-[40px] text-center '>视频标题</div>
      ...
      {/* 缩放图标 */}
      <div className='flex justify-between w-[1400px] mx-[auto] mb-[186px]'>
        <Image
          src={Mask1}
          alt="Album"
          className=' hover:transform  hover:scale-[120%]'
        />
        <Image
          src={Mask2}
          alt="Album"
      ...
      <div className='lg:w-[1400px] flex justify-between mx-[auto] text-white items-center mb-[140px]'>
        <div className='flex-1'>
          <div className='text-[36px] leading-[36px] text-center mb-[40px]'>Metaverse</div>
          <div className='text-[16px] leading-[16px] flex justify-between'>
            <span>Pursuit of reality</span>
            <span>Web 3.0 Community</span>
            <span>Virtual Market Building</span></div>
        </div>
        <Image
          src={metaverse}
          alt="Album"
          className='w-[528px] h-[580px] ml-[209px]'
        />
      </div>
      ...
      <div className='lg:w-[1400px] flex justify-between mx-[auto] text-white items-center mb-[140px]'>
        <div className='flex-1'>
          ...
          <div className='text-[16px] leading-[16px] flex justify-between flex-col'>
            ...
            <span>Solving Digital Bottlenecks</span></div>
        </div>
        <Image
          src={dmw}
          alt="Album"
          className='w-[240px] h-[534px] ml-[638px] mr-[100px]'
        />
      </div>


      <div className='lg:w-[1400px] flex justify-between mx-[auto] text-white items-center mb-[151px]'>
        <Image
          src={decentralized}
          alt="Album"
          className='w-[556px] h-[539px] mr-[431px]'
        />
        <div className='flex-1'>
          <div className='text-[36px] leading-[36px]  mb-[44px]'>Decentralized Finance</div>
          <div className='text-[16px] leading-[16px] flex justify-between flex-col'>
            <span className='mb-[32px]'>Simple and easy to use</span>
            <span className='mb-[32px]'>Instant Exchange with one tap</span>
            <span>Easy crypto asset Management</span></div>
        </div>
      </div>

      <div className='text-white text-[36px] leading-[36px] text-center font-[700] mb-[24px]'>ROADMAP</div>
      <div className='text-white text-[16px] leading-[16px] text-center  mb-[40px]'>This is the roadmap that shows the progression of our services</div>
      ...
      <div className='flex justify-between text-white w-[1400px] mx-[auto] mb-[140px]'>
        <div className='flex flex-col items-center'>
          <div>Blockchain</div>
          <img className='w-[220px] h-[64px] mt-[40px]' src="https://www.wfca.io/assets/img/logo-ethereum.svg" alt="" />
        </div>

        <div className='flex flex-col items-center'>
          <div className='mb-[40px]'>Team</div>
          <img className='mb-[40px]' src="https://www.wfca.io/assets/img/logo-dde.png" alt="" />
          <img src="https://www.wfca.io/assets/img/logo-99hualian.svg" alt="" />
        </div>


        <div className='flex flex-col items-center'>
          <div className='mb-[40px]'>Exchange</div>
          <div className='w-[220px] h-[55px] bg-[#003469] text-white leading-[55px] text-center font-[700]'>Coming Soon</div>
        </div>
        ...
        <div className='flex flex-col items-center'>
          ...
          <div className='bg-[#fff] px-[10px]'>
            <img className='w-[220px] h-[64px]' src="https://www.wfca.io/assets/img/logo-etherscan.svg" alt="" />
          </div>
        </div>
      ...
      <div style={style.bannar2} className='w-full h-[300px] text-white pt-[40px]'>
        ...
        <div className='w-[1400px] mx-[auto] flex justify-between'>
          ...
          <div className='w-[60px] h-[60px] flex align items-center mb-[40px]'>
            ...
            <div className='flex'>
              <img className='w-[40px] h-[40px] mr-[40px]' src="https://www.wfca.io/assets/img/icon-twitter-footer.svg" alt="" />
              <img className='w-[40px] h-[40px]' src="https://www.wfca.io/assets/img/icon-github-footer.svg" alt="" />
            </div>
            <div className='mt-[40px] text-white font-[700]'>WFCA. ALL RIGHTS RESERVED.</div>
          </div>
        </div>
      </div>
